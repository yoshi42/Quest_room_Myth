...
#define SSerialRX        15  // pin7 Serial Receive pin
#define SSerialTX        16  // pin2 Serial Transmit pin
#define SSerialTxControl 17  // pin3 RS485 Direction control
...
//delay(300);
 if (digitalRead(anal_comm_a9) == HIGH && digitalRead(anal_comm_a10) == LOW)
 {
    delay(50);
    p=1;
    time0=millis();
 ...
 if (digitalRead(anal_comm_a9) == LOW && digitalRead(anal_comm_a10) == HIGH)
 {
    delay(50);
    p=1;
    time0=millis();
