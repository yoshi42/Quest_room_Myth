...
#define SSerialTX        16  //Serial Transmit pin
...
#define anal_comm_a10 3
#define anal_comm_a11 2 //good
int flag_ru = 0;
int flag_en = 0;
int flag_heb = 0;
...
String string3 = "Master_Radio1_on_off#";
...
void loop() 
{
  ...
  if (digitalRead(anal_comm_a9) == HIGH && digitalRead(anal_comm_a10) == LOW && flag_ru == 0)
 {
    delay(50);
    flag_ru = 1;
 }
 ...
 if (digitalRead(anal_comm_a9) == LOW && digitalRead(anal_comm_a10) == HIGH && flag_en == 0)
 {
    delay(50);
    flag_en = 1;
 }
 ...
 if (digitalRead(anal_comm_a9) == LOW && digitalRead(anal_comm_a10) == LOW && flag_heb == 0)
 {
    delay(50);
    flag_heb = 1;
 }
...
void knock()
{
   ...
   void listen()
  {
    ...
    if (result)
    {
      ...
      delay(50);
      digitalWrite(anal_comm_a11,LOW);
      delay(1000);
      digitalWrite(anal_comm_a11,HIGH);
