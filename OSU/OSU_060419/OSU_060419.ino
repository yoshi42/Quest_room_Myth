...
void functionStart(){   
  ...
  if(flag == 4){
    ...
    if(digitalRead(S1_vikl)==HIGH){                         //включили выключатель
      ...
      delay(100);                 //вкл свет в коридоре 1
 ...
 ////////////////////////////////////////////////////////radiola1//////////
  ...
  if(flag == 7){
    Serial.println("flag=7 eff uhodite");
  ...
  //======================================КОРИДОР 2===========================================
  if(flag==8){
    Serial.println("flag=8 the secong room2");
    //Додати плавное включение света кор2
    digitalWrite(SSerialTxControl, HIGH);                 //передача данных
  ...
  if(flag == 13)
  {
    ...
    mp3_set_volume(18);
    delay (100);                                   
    mp3_play(3);                                     // вкл плеєр з эффектами аудbо "крик"
  ...
  if(flag==14){
    if(dio_p!=dio){
      Serial.println("flag=14 let's play XO)");
      dio_p=dio;
    }
    ...
    if(flag_XO_bad == 1){
      mp3_set_serial (pl_effectsSerial);                             //переключить на мп3 эфектов
      delay (100);                                   
      mp3_play ();                                     // вкл плеєр з эффектами аудио "детский плач" (НОМЕР УТОЧНИТЬ)
